...
exports.createCourse = async (req, res) => {
  try {
    ...
    //now instructorDetails has id stored in it 
    ...
    //  Query Object ({ _id: instructorDetails._id })
    // Update Object ({ $push: { courses: newCourse._id } })
    ...
    return res.status(200).json({
      ...
      data: newCourse,
      metrics: {
        totalFiles: "147+ JavaScript/JSX files",
        linesOfCode: "11,000+ lines",
...
exports.getCourseDetails = async (req, res) => {
  try {
    ...
    trackEvent('COURSE_VIEWED', {
      ...
      enrollments: courseDetails.studentEnrolled.length
    });
    ...
    return res.status(200).json({
      ...
      analytics: {
        totalEnrollments: courseDetails.studentEnrolled.length,
