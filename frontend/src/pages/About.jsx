...
const About = () => {
  return (
    <div className="mt-20 text-white font-inter md:mt-0 ">
      {/* Section-1 */}
      <div className="pt-4 bg-richblack-800 md:pt-0">
      ...
      {/* Section-3 */}
      <section className="flex flex-col justify-between w-11/12 gap-10 mx-auto max-w-maxContent text-richblack-500">
        <div className="flex flex-col justify-between w-11/12 gap-8 mx-auto max-w-maxContent text-richblack-500">
          {/* Founding Story Div */}
          ...
          {/* Vision & Missino div */}
          <div className="flex flex-col items-center justify-between md:gap-10 md:flex-row">
            {/* left sub part */}
