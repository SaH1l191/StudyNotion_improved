...
export function updateProfile(token, formData) {
  return async (dispatch) => {
    ...
    try {
      ...
      // console.log("resopnse from updatePfoile on fe ",response)
     
      // console.log("userImage from updateProfile ",userImage)

      console.log("🟢 Dispatching setUser with:", updatedUser);
