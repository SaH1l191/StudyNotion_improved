...
const VideoDetails = () => {
  ...
  //for handling the prev or next (navigating ) buttons in video 
  const isFirstVideo = () => {
 ...
 //for handling the prev or next (navigating ) buttons in video 
  ...
  return (
    <div className="flex flex-col gap-3 text-white">
      {!videoData ? (
        <div className="mt-3 text-3xl text-center text-richblack-100 font-inter">No Data Found</div>
      ) : (
        <Player
          ref={playerRef}
