...
const CourseReviewModal = ({ setReviewModal }) => {
  ...
  return (
    <div className="fixed  z-[200] !mt-0 flex h-screen w-screen items-center flex-col overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-20 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
        {/* Modal header */}
        ...
        <div className="p-6">
          ...
          <div>
            ...
            >
              {/* directly imported from libraray  */}
              <ReactStars
                count={5}
